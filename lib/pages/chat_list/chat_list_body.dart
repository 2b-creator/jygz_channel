...
class ChatListViewBody extends StatelessWidget {
  ...
  Future<void> _joinPublicSpace(Client client) async {
    var spaceProperty = await client.queryPublicRooms();
          for (var i = 0; i < spaceProperty.chunk.length; i++) {
            if (spaceProperty.chunk[i].roomType == "m.space") {
              client.joinRoomById(spaceProperty.chunk[i].roomId);
            }
          }
  }
  @override
